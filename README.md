...
**the original project - [jpetazzo/dockvpn](https://github.com/jpetazzo/dockvpn)** and it has its own [automatic build on dockerhub](https://hub.docker.com/r/nazgard/dockvpn). 
...
When the `nazgard/dockvpn` image is started, it generates:
...
Conveniently, `nazgard/dockvpn` comes with a script called `serveconfig`,
